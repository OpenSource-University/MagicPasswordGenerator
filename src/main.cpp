...
void choice_rkfgenerate(void){
    if (yesorno("GENERATE RAWKEYSFILE IMAGE ")){
        string pathfile;
        cout << "FilePath: ";
        cin >> pathfile;
        stringstream ss1;
...
void choice_rkfburn(void){
    if (yesorno("GENERATE RAWKEYSFILE IMAGE AND BURN ON AN CDROM ")){
        string pathfile;
        cout << "FilePath: ";
        cin >> pathfile;
        string symlink;
        cout << "symlink for burn: ";
        cin >> symlink;
...
void menu(void){
    ...
    while(true){
        system("clear");
        cout << "Welcome to the PDTSLSW tools! BUILD v1.0.1" << endl;
        cout << "# ========================================================================== #" << endl;
        ...
        cout << "# ========================================================================== #" << endl;
        cout << "(8)USE THE PDTSLSW RULES TOOL(8)" << endl;
