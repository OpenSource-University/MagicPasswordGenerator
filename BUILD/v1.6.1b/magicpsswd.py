...
class Rules_Dictator(object):
    def __init__(self,secret_init):
        ...
        self.describe=("MagicPasswordGenerator")
        self.Authors=["Rick Sanchez (D-634)"]
        self.Contact_Dev=["Rick Sanchez Contact e-mail: {} \nOSU public telegram: {}".format("informabox.contact@gmail.com","https://t.me/openuniv")]
    ...
    def display_entropy(self):
        entropy = self.external_senses.get_entropy()
    ...
    def display_WARNING_entropy(self):
        ...
        if entropy<200:
            ...
            print(colored("ALERT OF SECURITY! : Entropy too low({}), DANGER for SSL and cryptography!".format(entropy),'red'))
    # =====================================
    ...
    def welcome(self):
        os.system("clear")
        print(""" 
        Alpha Build(Only CDROM used)
        """)
        if self.IsAnBetaVersion==True:
            print(colored("!!__--**~IS AN BETA VERSION~**--__!!",'yellow')) 
        print("# ===================================== #")
        print(colored("TECH FROM OSU BY RICK SANCHEZ R&D DIVISION\n{}\nCODENAME: {}\nVersion: {}\nAuthors: {}\nDev Contact: {}\n".format(
            self.describe, self.CodeName, self.Version, "\n".join(self.Authors), "\n".join(self.Contact_Dev)),"green"))
        print("# ===================================== #")
        print("""
        WELCOME TO THE NORMAL USE CASE, END OF END, LAST STEP, AND YOU      
        CAN NOW USE THE MagicPasswordGenerator, just think 'No Need Brain For Password'...and Enjoy !    
        """) 
    # ===================================== 
